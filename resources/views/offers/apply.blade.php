...
@section('content')
    ...
    <div class="card w-75 text-center  mx-auto mt-3" id="content">
        ...
        <form action="{{ route('offers.sendEmail') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-6">
                        <input class="form-control" type="file" accept=".pdf" name="CV">  
                    </div>
                </div>
                <div class="row mt-3" >
                    <div class="col-3">
                    ...
                    <div class="col-6">
                        <input class="form-control" type="file" accept=".pdf" name="motivationLetter">  
                    </div>
                </div>
